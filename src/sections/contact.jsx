    ...
    <section className="relative w-full h-screen overflow-hidden" id="contact">
      ...
      <div className="relative w-full h-full flex flex-col items-center justify-center">
        <div className="w-full max-w-7xl px-8 mx-auto">
          <h1 className="text-white text-5xl font-bold mb-16">Contact Us</h1>
          <div className="flex flex-col md:flex-row justify-between gap-16">
            ...
            <form onSubmit={handleSubmit} className="w-full md:w-1/2 space-y-6">
              ...
              <input
                ...
                name="name"
                required
                className="w-full bg-transparent border border-white/30 rounded-lg p-4 text-white placeholder:text-white/70 focus:outline-none focus:border-white/50"
              />
              <input
                type="email"
              ...
              <button
                ...
                className="w-full bg-green-500 text-white rounded-lg p-4 hover:bg-green-600 transition-colors disabled:bg-green-800 disabled:cursor-not-allowed"
              >
            ...
            <div className="w-full md:w-1/2 space-y-6 text-white">
              <div className="flex items-center gap-4">
                <span>📞</span>
                <p>9921296658 / 8208423741</p>
              </div>
              <div className="flex items-center gap-4">
                <span>✉️</span>
                <p>devise.eng.tools@gmail.com</p>
              </div>
              <div className="flex items-center gap-4">
                <span>📍</span>
                <a
